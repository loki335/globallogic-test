...
base_url_get = "https://httpbin.org"
...
post_response =requests.post(base_url_post, data=json.dumps(data), headers=headers).json()
...
try:
    invalid_response = requests.post(base_url_post, data=json.dumps(invalid_data), headers=headers).json()
